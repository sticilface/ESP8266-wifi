...
COOLBLOBS,UDP,RAINBOWCYCLE,SPIRAL,TEST2,TEST3,TEST4,SQUARES,EQ1
};
...
"Cool Blobs", "UDP", "Rainbow Cycle","Spiral","Test2","Test3","Test4","Squares","EQ1" 
};
#define numberofmodes 19 /////// DONT FORGET THIS....
